...
[Документация модуля sys](https://docs.python.org/3/library/sys.html)

`sys` - предоставляет прямой доступ к переменным и функциям, которые взаимодействуют с интерпретатором Python, обеспечивая основу для создания надёжных инструментов автоматизации. Все переменные доступны только для чтения.
